...
import static com.abiquo.commons.amqp.impl.scheduler.SchedulerConfiguration.SCHEDULER_NOTIFICATIONS_QUEUE;
...
public class SchedulerConsumer extends BaseConsumer<SchedulerCallback>
{
    ...
    {
        super(new SchedulerConfiguration(), SCHEDULER_NOTIFICATIONS_QUEUE);
    }
